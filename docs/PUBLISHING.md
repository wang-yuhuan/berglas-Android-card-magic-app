# GitHub 发布资料 / GitHub publishing notes
...
安卓魔术软件 berglas / berglas — Android Magic App

## 简介 / About

中文：基于 Kotlin 与 Jetpack Compose 的离线 Android 纸牌魔术工具，支持 52 张自由拖动纸牌、双击翻牌和红蓝牌组。
...
1. 解压 dist/berglas-github-source.zip 到新的空文件夹。
   Extract dist/berglas-github-source.zip into a new empty folder.
2. 使用 GitHub Desktop 将该文件夹添加为本地仓库；若提示尚未初始化，则创建仓库。
   Add it as a local repository in GitHub Desktop and initialize it if needed.
3. 检查待提交文件，提交并发布到你新建的 GitHub 仓库。
   Review the file list, commit, and publish to your new GitHub repository.
